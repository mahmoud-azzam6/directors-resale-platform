...
Detailed approved behavior is defined by `docs/architecture/LISTING_DOMAIN_ARCHITECTURE.md`; the approved conceptual physical model is defined by `docs/architecture/LISTING_PHYSICAL_DATA_MODEL.md`. BF013 implemented and verified the approved Property & Ownership Foundation boundary defined in `docs/sprints/BF013-property-ownership-foundation.md`; the broader Listing Domain remains not implemented.
