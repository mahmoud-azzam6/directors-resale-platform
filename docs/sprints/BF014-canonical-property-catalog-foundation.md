...
BF014 is the selected current Backend sprint and remains **IN PROGRESS**. BF014.1, BF014.2, BF014.3, and BF014.4A are **IMPLEMENTED AND VERIFIED / CLOSED**. BF014.4 remains **IN PROGRESS** with BF014.4B **NEXT / NOT STARTED**; BF014.4C-BF014.4F and BF014.5-BF014.8 remain **NOT STARTED**, and BF015 or subsequent sprints are not selected. This parent contract remains authoritative for scope and future BF014 work.
...
| --- | --- | --- | --- |
| APARTMENT | RESIDENTIAL | شقة | Apartment |
| DUPLEX | RESIDENTIAL | دوبلكس | Duplex |
| PENTHOUSE | RESIDENTIAL | بنتهاوس | Penthouse |
| STUDIO | RESIDENTIAL | استوديو | Studio |
| VILLA | RESIDENTIAL | فيلا | Villa |
| TOWNHOUSE | RESIDENTIAL | تاون هاوس | Townhouse |
| TWIN_HOUSE | RESIDENTIAL | توين هاوس | Twin House |
| CHALET | RESIDENTIAL | شاليه | Chalet |
| RETAIL_SHOP | COMMERCIAL | محل تجاري | Retail Shop |
| COMMERCIAL_UNIT | COMMERCIAL | وحدة تجارية | Commercial Unit |
| WAREHOUSE | COMMERCIAL | مستودع | Warehouse |
| OFFICE | ADMINISTRATIVE | مكتب | Office |
| ADMINISTRATIVE_UNIT | ADMINISTRATIVE | وحدة إدارية | Administrative Unit |
| CLINIC | MEDICAL | عيادة | Clinic |
| MEDICAL_CENTER | MEDICAL | مركز طبي | Medical Center |
| RESIDENTIAL_LAND | LAND | أرض سكنية | Residential Land |
| COMMERCIAL_LAND | LAND | أرض تجارية | Commercial Land |
| AGRICULTURAL_LAND | LAND | أرض زراعية | Agricultural Land |
| INDUSTRIAL_LAND | LAND | أرض صناعية | Industrial Land |
...
| Code | Arabic | English |
| --- | --- | --- |
| BUILT_UP_AREA | المساحة المبنية | Built-up Area |
| PLOT_AREA | مساحة الأرض | Plot Area |
| NET_AREA | المساحة الصافية | Net Area |
| GARDEN_AREA | مساحة الحديقة | Garden Area |
| TERRACE_AREA | مساحة التراس / البلكونة | Terrace / Balcony Area |
| ROOF_AREA | مساحة السطح | Roof Area |
...
| --- | --- | --- | --- |
| BEDROOMS | INTEGER | غرف النوم | Bedrooms |
| BATHROOMS | INTEGER | الحمامات | Bathrooms |
| FLOOR | INTEGER | الطابق | Floor |
| FLOORS | INTEGER | عدد الطوابق | Number of Floors |
| PARKING_SPACES | INTEGER | أماكن الانتظار | Parking Spaces |
| FURNISHING | ENUM | حالة الفرش | Furnishing |
| FINISHING | ENUM | حالة التشطيب | Finishing |
| VIEW | TEXT | الإطلالة | View |
| BALCONY | BOOLEAN | بلكونة / تراس | Balcony / Terrace |
| GARDEN | BOOLEAN | حديقة | Garden |
| MAID_ROOM | BOOLEAN | غرفة خادمة | Maid Room |
| STORAGE | BOOLEAN | مخزن | Storage |
| DELIVERY_STATUS | ENUM | حالة الاستلام | Delivery Status |
| DELIVERY_DATE | DATE | تاريخ الاستلام | Delivery Date |
| YEAR_BUILT | INTEGER | سنة البناء | Year Built |
...
| --- | --- | --- | --- |
| FURNISHING | UNFURNISHED | غير مفروشة | Unfurnished |
| FURNISHING | SEMI_FURNISHED | نصف مفروشة | Semi-Furnished |
| FURNISHING | FURNISHED | مفروشة | Furnished |
| FINISHING | UNFINISHED | بدون تشطيب | Unfinished |
| FINISHING | SEMI_FINISHED | نصف تشطيب | Semi-Finished |
| FINISHING | FINISHED | تشطيب كامل | Finished |
| FINISHING | LUXURY_FINISHED | تشطيب فاخر | Luxury Finished |
| DELIVERY_STATUS | READY_TO_MOVE | جاهزة للاستلام | Ready to Move |
| DELIVERY_STATUS | UNDER_CONSTRUCTION | تحت الإنشاء | Under Construction |
...
Country: EG | مصر | Egypt | COUNTRY. Seed exactly these 27 children under EG, each with type GOVERNORATE:
...
These are implementation units within BF014, not separate sprints. BF014.1, BF014.2, BF014.3 and BF014.4A are closed; BF014.4B is NEXT / NOT STARTED; BF014.4C-BF014.4F and BF014.5-BF014.8 remain NOT STARTED.
