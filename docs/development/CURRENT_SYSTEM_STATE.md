...
BF014 is the current Backend sprint: **IN PROGRESS**. BF014.1 through BF014.6 are **IMPLEMENTED AND VERIFIED / CLOSED**. BF014.7 is **NEXT / NOT STARTED**; BF014.8 is **NOT STARTED**. Rich Property Profile and Listing remain **APPROVED / NOT IMPLEMENTED**. BF015 and later sprints are not selected.
