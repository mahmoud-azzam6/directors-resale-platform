...
BF014 is the current Backend sprint: **IN PROGRESS**. BF014.1 through BF014.5 are **IMPLEMENTED AND VERIFIED / CLOSED**. BF014.6 is **NEXT / NOT STARTED**; BF014.7-BF014.8 are **NOT STARTED**. The [BF014.4 contract](../sprints/BF014.4-authorization-and-http.md) records the authorization and HTTP boundary. Rich Property Profile and Listing remain **APPROVED / NOT IMPLEMENTED**. BF015 and later sprints are not selected.
