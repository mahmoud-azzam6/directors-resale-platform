...
foreach(['seed','projection','assignments','proposals','listings','marketplace']as$forbidden)if(str_contains(strtolower($routes),$forbidden))throw new RuntimeException("Unexpected route surface $forbidden");
